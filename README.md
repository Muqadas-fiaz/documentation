# Documentation
    ...
    Customizability and Extensibility:
        Both tools are highly customizable. Prometheus allows custom metrics to be defined and collected, while Grafana enables users to create dashboards with flexible layouts, templating, and plugins to extend functionality.Install Prometheus on Ubuntu 20.04¶
